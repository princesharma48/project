...
if (isset($_POST['save_category'])) {
    ...
    $query = "insert into products(title,sdescription,description,addinfo,slug,cat_id,sub_cat_id,type,brand,industry,created_at) values('$title','$sdescription','$description','$addinfo','$slug','$cat_id','$subcategory','$type',$brand,$industry,'$created_at')";
    ...
    if ($query_run) {
        ...
        foreach ($_FILES["files"]["tmp_name"] as $key => $tmp_name) {
            ...
            move_uploaded_file($file_tmp = $_FILES["files"]["tmp_name"][$key], "uploads/products/" . $file_name);
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Brands</label>
                                            <?php $query = "SELECT * FROM brand_logo";
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="texteditor" name="addinfo"></textarea>
                                        </div>
                                    </div>
                                    <div class="container mt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <button id="addTab" class="btn btn-primary mt-4">Add Tab</button>
                                            </div>
                                        </div>
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        ...
                                        foreach ($query_run as $prod_item) {
                                            ...
                                            <tr style="text-align:center;">
                                                ...
                                                ?>"
                                                        style="height:auto; width:100%; border-radius:0px; display: block;" /></noscript>
                                                </td>
                                                <td>
                                                    <label class="switch">
...
<script src="https://cdn.tiny.cloud/1/s88v5l56btmnc0zvnrfb2eenpkufzze7ixrnt2d5dtk9sq51/tinymce/7/tinymce.min.js"
